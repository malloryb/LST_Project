...
```{r, echo=FALSE, warning=FALSE}
x <- read.csv("C:/Users/malbarn/Documents/Datasets/mms_temp_comp.csv")
...
ModisPlot<-ggplotRegression(lm(Modis_Temp ~Tower_TAavg, data = x))

grid.arrange(TaTsplot, DaymetPlot, GridmetPlot, ModisPlot, top="Comparisons with Ts and Gridded Products - US-Mms")
```
...
```{r, echo=FALSE, warning=FALSE}
x <- read.csv("C:/Users/malbarn/Documents/Datasets/dk2_temp_comp.csv")
...
grid.arrange(TaTsplot, DaymetPlot, GridmetPlot, ModisPlot, top="Comparisons with Ts and Gridded Products - US-Dk2")
```
...
```{r, echo=FALSE, warning=FALSE}
x <- read.csv("C:/Users/malbarn/Documents/Datasets/dk1_temp_comp.csv")
...
grid.arrange(TaTsplot, DaymetPlot, GridmetPlot, ModisPlot, top="Comparisons with Ts and Gridded Products - US-Dk1")
```
#### Morgan Monroe State Forest
...
```{r, echo=FALSE, warning=FALSE}
y <- read.csv("C:/Users/malbarn/Documents/Datasets/mms_temp_comp.csv")
...
```{r, echo=FALSE, warning=FALSE}
y <- read.csv("C:/Users/malbarn/Documents/Datasets/dk2_temp_comp.csv")
y$date <- as.Date(y$date)
...
```{r, echo=FALSE, warning=FALSE}
y <- read.csv("C:/Users/malbarn/Documents/Datasets/dk1_temp_comp.csv")
y$date <- as.Date(y$date)
...
MODIS LST: Very bad overestimation
```{r, echo=FALSE, warning=FALSE}
y <- read.csv("C:/Users/malbarn/Documents/Datasets/dk1_temp_comp.csv")
y$date <- as.Date(y$date)
