...
fname <- ("Other/air.mon.mean.v501.nc")
...
Diffs  <- brick("/Volumes/G-RAID Thunderbolt 3/Temp_Project/Processed/Ta_AquaTs_All.tif")
...
<!-- LC_proj <- raster("/Users/malbarn/Documents/LST_DataTemp_Project/landcvi020l_nt00016/landcover_proj.tif") -->
<!-- ext <- extent(Diffs2) -->
...
#write.csv(df, "/Users/malbarn/Documents/LST_Data/Aqua_for_plotting.csv")
df <- read.csv("/Users/malbarn/Documents/LST_Data/Aqua_for_plotting.csv")
...
Landcover <- raster("/Users/malbarn/Documents/LST_Data/NCLD_2008_processed.tif")
ext <- extent(Diffs2)
...
#write.csv(dfland, "/Users/malbarn/Documents/LST_DataTemp_Project/APPEARS_LST/Aqua_Landsat_plotting.csv")
df_landsat <- read.csv("/Users/malbarn/Documents/LST_DataTemp_Project/APPEARS_LST/Aqua_Landsat_plotting.csv")
...
Ta <- brick("/Users/malbarn/Documents/LST_DataTemp_Project/Ta_All.tif")
...
#Landcover_Rast <- raster("/Users/malbarn/Documents/LST_DataTemp_Project/NLCD_LandCover/NCLD_2008_processed.tif")
...
#plot(LC)
#barplot(LC)
#writeRaster(LC, "/Users/malbarn/Documents/LST_DataTemp_Project/NLCD_LandCover/NCLD_Mask.tif")
Landcover_Rast <- raster("/Users/malbarn/Documents/LST_Data/NCLD_Mask.tif")
...
#write.csv(Writeout, "/Users/malbarn/Documents/LST_DataTemp_Project/09072019_all_files_daily.csv")
...
To_Plot<- read.csv("/Users/malbarn/Documents/LST_Data/090719_Forplottingmoneyfig.csv")
#For when it isn't already saved (but it is)
#To_Plot <- do.call("rbind", lapply(sitelist, Format_plot_temps))
#write.csv(To_Plot, "/Users/malbarn/Documents/LST_DataTemp_Project/090719_Forplottingmoneyfig.csv")
...
Landcover_Rast <- raster("/Users/malbarn/Documents/LST_Data/NCLD_Mask.tif")
Diffs  <- brick("/Users/malbarn/Documents/LST_Data/Ta_AquaTs_All.tif")
names(Diffs) <- c('Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec')
#Changing the sign so that negative means cooling, positive means warming
Diffs2 <- -Diffs

Monthly_Ta_Ts <- function(year){
  filenamelst <- paste0("/Users/malbarn/Documents/LST_DataTemp_Project/MODIS_AquaLST_", year, ".tif", sep="")
  filenamedaymet1 <- paste0("/Users/malbarn/Documents/LST_DataTemp_Project/Daymet/daymet_v3_tmax_monavg_", year, "_na.tif")
  #filenamedaymet2 <- paste0("/Users/malbarn/Documents/LST_DataTemp_Project/Daymet/daymet_v3_tmin_monavg_", year, "_na.tif")
